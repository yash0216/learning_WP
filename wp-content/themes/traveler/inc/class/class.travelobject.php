					        ...
					        $sql = "SELECT
                                ...
                                (
                                    SELECT CASE
                                                ...
                                                THEN
                                                     CAST({$wpdb->prefix}{$post_type}.max_price AS DECIMAL) - ( CAST({$wpdb->prefix}{$post_type}.max_price AS DECIMAL) / 100 ) * CAST({$wpdb->prefix}{$post_type}.discount_rate AS DECIMAL)
                                                ...
                                                ELSE {$wpdb->prefix}{$post_type}.max_price
