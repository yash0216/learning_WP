                                    ...
                                    <?php foreach ($car_package_custom as $key => $val): ?>
                                        <li>
                                            ...
                                            <div class="select-wrapper">
                                                <div class="caculator-item">
                                                    <i class="fa fa-minus"></i>
                                                        <input class="form-control app extra-service-select" id="car_field_qty_<?php echo esc_attr($key); ?>" type="input" value="0" name="car_quantity[<?php echo 'custom_' . esc_attr($key); ?>][]" step="1"  min="0" <?php if(!empty($car_quantity)){?> max="<?php echo esc_attr($car_quantity);?>" <?php }?>>
                                                    <i class="fa fa-plus"></i>
                                                </div>
                                            </div>
                                        </li>
