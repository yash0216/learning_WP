...
?>
<div class="services-item list list-vertical item-elementor" itemscope itemtype="https://schema.org/Trip" data-id="<?php echo esc_attr($post_id); ?>">
    <div class="item service-border st-border-radius">
        ...
        <div class="content-item">
            <div class="content-item-left">
                ...
                <div class="price-wrapper section-footer w-100 service-type d-sm-block d-md-block d-lg-block">
