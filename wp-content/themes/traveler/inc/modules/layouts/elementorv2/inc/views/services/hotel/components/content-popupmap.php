...
<div class="col-sm-12 col-md-9 col-lg-9">
    <?php echo stt_elementorv2()->loadView('services/hotel/components/toolbar', ['style' => $style, 'has_filter' => true]); ?>
        ...
        if($query->have_posts()) {
            while ($query->have_posts()) {
                $query->the_post();
                    ...
                    if($style == 'list'){
                        echo '<div class="col-12item-service">';
                        echo stt_elementorv2()->loadView('services/hotel/loop/list-2');
                        echo '</div>';
                    }else{
                        echo '<div class="col-12 col-md-4 col-lg-4 item-service">';
