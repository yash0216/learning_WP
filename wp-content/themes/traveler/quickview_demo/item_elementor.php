...
?>
<div class="col-sm-6">
    <div class="item has-matchHeight <?php echo esc_attr($status); ?>">
        <a href="<?php echo esc_url($v['url']); ?>" title="<?php echo esc_attr($v['heading']); ?>" target="_blank">
            ...
            <img src="<?php echo esc_url(get_template_directory_uri() . '/quickview_demo/img/' . esc_attr($v['thumb'])); ?>" alt="<?php echo esc_attr($v['heading']); ?>" class="img-responsive">
        </a>
