...
if (!class_exists('ST_Destination_Element')) {
    class ST_Destination_Element extends \Elementor\Widget_Base
    {
        ...
        {
            $layout_style = apply_filters('st_layout_style_destination',
                [
            ...
            $this->add_control(
                ...
                [
                    ...
                    'delay' => 100,
                    'condition' => [
                        'layout_style' => ['normal','slider','style-slider-2']
                    ]
                ]
            );
            $this->add_control(
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default' => '3',
                    'condition' => [
                        'layout_style!' => ['slider','style-slider-2']
                    ]
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default' => 6,
                    'condition' => ['layout_style' => ['slider','style-slider-2']]
                ]
            );
            ...
            $this->add_control(
                'color_title',
                [
                    'label' => esc_html__( 'Color', 'traveler' ),
                    'type' => \Elementor\Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .destination-item .title a' => 'color: {{VALUE}} !important',
                        '{{WRAPPER}} .destination-item .desc a' => 'color: {{VALUE}} !important',
                    ],
                    'condition' => [
                        'layout_style' => ['normal', 'tab']
                    ],
                ]
            );
            $this->add_group_control(
