        ...
        protected function register_controls()
        {
            ...
            $this->add_control(
                ...
                [
                    ...
                    'description' => esc_html__('Enter Office', 'traveler'),
                    'type' => \Elementor\Controls_Manager::TEXT,
                    'default' => '',
                ]
            );
            ...
            $this->add_control(
                'name_color',
                [
                    'label' => esc_html__( 'Name color', 'traveler' ),
                    'type' => \Elementor\Controls_Manager::COLOR,
                    'default' => '',
                    'selectors' => [
                        '{{WRAPPER}} .item-personal-infor p.name' => 'color: {{VALUE}};',
                    ],
                ]
            );
            $this->add_group_control(
                ...
                [
                    ...
                    'label' => esc_html__('Typography for Name', 'traveler'),
                    'selector' => '{{WRAPPER}} .item-personal-infor p.name',
                ]
            );
            ...
            $this->add_control(
                'office_color',
                [
                    'label' => esc_html__( 'Office color', 'traveler' ),
                    'type' => \Elementor\Controls_Manager::COLOR,
                    'default' => '',
                    'selectors' => [
                        '{{WRAPPER}} .item-personal-infor p.position' => 'color: {{VALUE}};',
                    ],
                ]
            );
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'label' => esc_html__('Typography for Office', 'traveler'),
                    'selector' => '{{WRAPPER}} .item-personal-infor p.position',
                ]
            );
