...
<div id="st-content-wrapper" class="search-result-page">
    ...
    <div class="container">
        <div class="st-results st-hotel-result style-full-map">
			<?php echo st()->load_template('layouts/elementor/hotel/elements/top-filter/top-filter'); ?>
            <div class="row">
                <?php
                if($sidebar_pos == 'left'){
                    echo st()->load_template('layouts/elementor/hotel/elements/sidebar');
                }
                ?>
                <?php
                $query           = array(
                ...
                echo st()->load_template('layouts/elementor/hotel/elements/content');
