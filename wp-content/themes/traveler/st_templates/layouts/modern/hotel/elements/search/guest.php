	...
	<ul class="dropdown-menu" aria-labelledby="dropdown-advance">
		...
		<div class="form-guest-search">
			<li class="item">
				...
				<div class="select-wrapper">
					<div class="st-number-wrapper">
						<input type="text" name="adult_number" value="<?php echo esc_attr( $adult_number ); ?>" class="adult_number form-control st-input-number" autocomplete="off" readonly data-min="1" data-max="<?php echo esc_attr( $adult_max ); ?>"/>
					</div>
				</div>
			</li>
			<li class="item">
				...
				<div class="select-wrapper">
					<div class="st-number-wrapper">
						<input type="text" name="child_number" value="<?php echo esc_attr( $child_number ); ?>" class="child_number form-control st-input-number" autocomplete="off" readonly data-min="0" data-max="<?php echo esc_attr( $child_max ); ?>"/>
					</div>
				</div>
			</li>
		</div>
