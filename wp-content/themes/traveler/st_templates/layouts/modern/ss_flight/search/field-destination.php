...
<div class="form-group form-group-lg form-group-icon-left st_right">
    ...
    <div class="st-select-wrapper ss-flight-wrapper" >
        <input required id="ss_location_destination" type="text" class="ss-flight-location required" autocomplete="off" data-value="" data-name="ss_destination" value="" placeholder="<?php echo esc_html__('Enter destination', 'traveler'); ?>" data-index="2">
    </div>
</div>