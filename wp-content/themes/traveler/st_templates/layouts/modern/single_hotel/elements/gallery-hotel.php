	    ...
	    <div class="row list-group  st-gallery-grid">
			...
			?>
		        <div class="item  <?php echo esc_attr($class);?>">
		            <div class="thumbnail">
		                <a class="galleryItem" href="<?php echo esc_url($image_src[0]);?>" data-group="grid" title=""><img class="group list-group-image" src="<?php echo ($image_src[0]);?>" alt="<?php echo esc_attr($tes_title);?>" /></a>
		            </div>
		        </div>
		    <?php }?>
	    </div>
