    ...
    <div class="tab-content">
        <div class="tab-pane fade active in author-sv-list" id="tab-all">
            ...
            if ($query->have_posts()) {
                switch ($service) {
                    case "hotel":
                        echo '<div class="search-result-page"><div class="st-hotel-result modern-search-result"><div class="row row-wrapper">';
                        break;
                    case "tours":
                        echo '<div class="search-result-page st-tours"><div class="st-hotel-result modern-search-result"><div class="row row-wrapper">';
                        break;
                    case "activity":
                        echo '<div class="search-result-page st-tours st-activity"><div class="st-hotel-result modern-search-result"><div class="row row-wrapper">';
                        break;
                    case "cars":
                        echo '<div class="search-result-page st-tours"><div class="st-hotel-result modern-search-result"><div class="row row-wrapper">';
                        break;
                    case "rental":
                        echo '<div class="search-result-page st-rental "><div class="st-hotel-result modern-search-result"><div class="row row-wrapper">';
                        break;
                    // case "flight":
