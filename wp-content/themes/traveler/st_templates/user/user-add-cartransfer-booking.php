			...
			<div id="collapseTwo" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingTwo">
					...
					<div class="panel-body">
						...
						<div class="row">
							...
							<div class="col-xs-12 col-sm-3">
								<div class="form-group">
									<label  for="selected_return" class="head_bol"><?php _e( 'Return', 'traveler' ); ?>:</label>
									<div id="return-wrapper">

									</div>
									<input type="hidden" name="selected_return" id="selected_return" value="">
								</div>
							</div>
							<div class="col-xs-12 col-sm-3">
								<div class="form-group">
									<label  for="selected_passenger" class="head_bol"><?php _e( 'Passenger', 'traveler' ); ?>:</label>
									<div id="passenger-wrapper">

									</div>
									<input type="hidden" name="selected_passenger" id="selected_passenger" value="">
								</div>
							</div>
						</div>
