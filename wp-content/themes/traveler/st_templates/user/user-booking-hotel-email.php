...
<form class="form-inline booking-email-filter"
    ...
    <div class="form-group">
        ...
        <input type="number"  value="<?php echo esc_attr($from); ?>" name="from" class="form-control input-sm"
               id="out_of_from"
               placeholder="<?php echo __('Number from', 'traveler'); ?>">
    </div>
    <div class="form-group">
        <label class="sr-only" for="out_of_to"><?php echo __('To', 'traveler'); ?></label>
        <input type="number" value="<?php echo esc_attr($to); ?>" name="to" class="form-control input-sm" id="out_of_to"
               placeholder="<?php echo __('Number to', 'traveler'); ?>">
    </div>
