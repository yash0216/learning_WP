					...
					<div class="panel-body">
						...
						<div class="row">
							...
							<div class="col-xs-12 col-sm-6">
								...
								?>
									<input id="pick_up" data-car-type="car" type="hidden" name="location_id" value="<?php /*echo esc_attr($pick_up); */ ?>" class="form-control custom-form-control required" data-pl-name="<?php /*echo esc_attr($pick_up_name); */ ?>">
								</div>
							</div>
						...
						<div class="row">
							...
							<div class="col-xs-12 col-sm-3">
								...
								?>
									<div class="input-group">
										<span class="input-group-addon" id="basic-checkin"><i class="fa fa-calendar"></i></span>
										<input readonly aria-describedby="basic-checkin" data-date-format="<?php echo TravelHelper::getDateFormatJs(); ?>" autocomplete="off" type="text" name="pick-up-time" id="check_in_time" value="<?php echo esc_attr( $pick_up_time ); ?>" class="st_timepicker required form-control">
								</div>
							...
							<div class="col-xs-12 col-sm-3">
								...
								?>
									<div class="input-group">
										<span class="input-group-addon" id="basic-checkin"><i class="fa fa-calendar"></i></span>
										<input readonly aria-describedby="basic-checkin" data-date-format="<?php echo TravelHelper::getDateFormatJs(); ?>" autocomplete="off" type="text" name="drop-off-date" id="check_out_car" value="<?php echo esc_attr( $drop_off_date ); ?>" class="form-control required">
								</div>
							...
							<div class="col-xs-12 col-sm-3">
								...
								?>
									<div class="input-group">
										<span class="input-group-addon" id="basic-checkin"><i class="fa fa-calendar"></i></span>
										<input readonly aria-describedby="basic-checkin" data-date-format="<?php echo TravelHelper::getDateFormatJs(); ?>" autocomplete="off" type="text" name="drop-off-time" id="check_out_time" value="<?php echo esc_attr( $pick_up_time ); ?>" class="st_timepicker form-control required">
								</div>
						...
						<div class="form-group">
							...
							<input type="hidden" name="car_post_type" value="st_cars">
							<div class="clearfix">
								<div class="row">
									<div class="col-sm-6">
										<?php
