...
<div class="info">
	...
	<div class="clearfix mt10"><strong><?php echo __('Amount: ', 'traveler'); ?></strong> <div class="pull-right"><strong><?php echo TravelHelper::format_money( $total_price ); ?></strong></div></div>
	...
	<div class="clearfix mt10"><strong><?php echo __('Amount refunded: ', 'traveler'); ?></strong> <div class="pull-right"><strong><?php echo TravelHelper::format_money( $refunded ); ?></strong></div></div>
