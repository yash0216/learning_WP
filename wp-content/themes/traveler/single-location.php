...
if ( $new_layout == 'modern' ) {
    ...
    if(check_using_elementor()){
        $style_location_detail = st()->get_option( 'style_location_detail', 'style_1' );
        if($style_location_detail === 'style_2'){
            echo stt_elementorv2()->loadView('location/single',['style_single' => $style_location_detail]);
        } else {
