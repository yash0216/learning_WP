...
if ($query_service->have_posts()) { ?>
    <div class="st-list-service st-sliders st-style-arrow horizontal-border <?php echo esc_attr($layout_style); ?>" <?php echo st_render_html_attributes($attrs); ?> <?php echo ' data-responsive="' . esc_attr(json_encode($responsive)) . '"'; ?>>
                        ...
                        <div class="services-item grid item-elementor">
                            <div class="item">
                                <div class="featured-image">
                                    <a href="<?php echo get_the_permalink(); ?>" class="border-radius-10">
                                ...
                                <div class="content-item border-radius-20 service-border-lib">
                                    <?php
                                    ...
                                    if (!empty($category_detail)) {
                                        ...
                                        <div class="cate category-color">
                                            <ul>
                                                ...
                                                $bg_rgba = st_hex2rgb_new($color, 0);
