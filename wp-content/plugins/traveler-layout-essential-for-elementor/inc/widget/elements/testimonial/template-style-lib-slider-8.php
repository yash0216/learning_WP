            ...
            <div class="swiper-wrapper">
                ...
                foreach ($list_testimonial as $item_tes) { ?>
                    <div class="item <?php echo esc_attr($class_col); ?>">
                        <div class="content col-12 col-lg-5 col-md-5 col-sm-5">
                            <div class="content-item st-content-lib">
                                <p><?php echo esc_html($item_tes["content_testimonial"]); ?></p>
                                </div>
                                <div class="author-meta author-meta-lib">
                                    <h4><span class="author-name"><?php echo esc_html($item_tes["name_testimonial"]); ?></span></h4>
                                    <div class="star">
                                        <?php
                                    ...
                                    <span class="description office-testimonial-lib"><?php echo esc_html($item_tes["office_testimonial"]); ?></span>
                                </div>
                            
                        </div>
                        <div class="author col-12 col-lg-7 col-md-7 col-sm-7">
                            <?php
                            if (!empty($item_tes["st_avatar_testimonial"]['url'])) {
                            ?>
                                <img src="<?php echo esc_url($item_tes["st_avatar_testimonial"]['url']); ?>" alt="<?php echo esc_attr($item_tes["name_testimonial"]); ?>">
                            <?php }
                            ?>
                        </div>
                    </div>
